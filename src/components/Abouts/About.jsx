    ...
    <section id="about">
      <div className="card section__wrapper">
        ...
        <div className="column right-column">
          ...
          <h1 className="title">
            I am <span className="color__primary">Uche Prince</span>
          </h1>
          <p className="text__muted description">
            ...
            frontend technologies, framework, and design principles. Adept at
            transforming ideas into seamless user experiences with clean,
            efficient, and scalable code. Strong attention to details, problem
            -solving skills, and a proven track record of delivering visually
            stunning, high-quality projects on time.
          </p>
        </div>
      </div>
    </section>
